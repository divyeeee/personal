...
"""imread reads our image, arguements include file name and second arguement is our flag which specifies how our image will be read, ie either grayscale=0,color=-1,same image through alpha channels=1"""
